...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description:
      "Every Assets in our platform is verified by our team to ensure our highest quality standards. not Happy ? We offer a 30-day refund Guarentee.",
  },
  {
    name: "For planet",
    Icon: Leaf,
...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper>
        <div className="py-20 mx-auto item-center  max-w-3xl items-center flex flex-col">
        ...
        <ProductReel
          ...
          title="Brand New"
          subTitle="Get the brand New Product NOW!!!"
          href="/products"
        />
      </MaxWidthWrapper>
